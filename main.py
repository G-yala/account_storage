...
class POPUpWindow(object):
    ...
    def __init__(self, m):
        top = self.top = Toplevel(m)
        top.title('Password')
        top.geometry('200x150 + 400 + 300')
    ...
    def cleanup(self):
        ...
        if self.value == access:
            ...
            messagebox.showerror(
                "Incorrect Password", "Incorrect password, remaining attempts: " + str(7 - self.attempts))


class entity_add:

    def __init__(self, m, n, p, e):
        self.password = p
        self.name = n
        self.email = e
        self.window = m
...
class entity_display:
    ...
    def __init__(self, m, n, e, p, i):
        ...
        self.label_name = Label(
            self.window, text=dencryptedN, font=('Courier', 16))
        self.label_email = Label(
            self.window, text=dencryptedE, font=('Courier', 16))
        self.label_pass = Label(
            self.window, text=dencryptedP, font=('Courier', 16))
    ...
    def delete(self):
        answer = tkinter.messagebox.askquestion(
            'Delete', 'Are you positive you want to delete this entry?')
